...
def insert_fwd(design_var, destination, coords):
  return insert_design_variable(design_var, destination, coords), coords

def insert_bwd(residuals, g):
  coords = residuals
  return (g[coords[0]:coords[2], coords[1]:coords[3]], None, None)

insert_design_variable.defvjp(insert_fwd, insert_bwd)
